...
const dataProducts = [
  { id: 1, name: 'Vendor Master Data', description: 'Comprehensive vendor registry with compliance certification status and risk scoring', domain: 'Procurement', owner: 'Maria Chen', dept: 'Finance & Accounting', classification: 'Internal', source: 'eCAPS', refresh: 'Daily', tables: 5, rows: '45K', quality: 94, tags: ['vendor', 'procurement', 'risk'], status: 'Active' },
  { id: 2, name: 'Budget & Expenditure Analytics', description: 'Departmental budget allocations, actuals, encumbrances, and variance analysis', domain: 'Finance', owner: 'James Park', dept: 'Finance & Accounting', classification: 'Internal', source: 'eCAPS/CAPS+', refresh: 'Daily', tables: 8, rows: '2.5M', quality: 91, tags: ['budget', 'finance'], status: 'Active' },
  ...
  { id: 4, name: 'Vendor Payment Transactions', description: 'All vendor payments with commodity codes, POs, and fraud detection indicators', domain: 'Procurement', owner: 'Maria Chen', dept: 'Finance & Accounting', classification: 'Internal', source: 'eCAPS', refresh: 'Daily', tables: 6, rows: '15M', quality: 92, tags: ['payments', 'fraud'], status: 'Active' },
  { id: 5, name: 'Internal Billing & Cost Allocation', description: 'Inter-departmental service charges and billing anomaly detection', domain: 'Finance', owner: 'James Park', dept: 'Finance & Accounting', classification: 'Internal', source: 'eCAPS', refresh: 'Monthly', tables: 4, rows: '350K', quality: 87, tags: ['billing', 'cost-allocation'], status: 'Active' },
